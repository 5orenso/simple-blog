...
var markdownOutput = {
    ...
    image: '<p class="image_inline"><a href="http://www.example.com/image.jpg" data-smoothzoom="group1"><img src="http://www.example.com/image.jpg" alt="my image" title="my image"></a></p>'
};
