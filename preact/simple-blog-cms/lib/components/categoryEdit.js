            ...
            <div class='container-fluid col-12'>
                ...
                <div class='row'>
                    <div class='col-6'>
                        ...
                        <div class='form-group'>
                            <label for='startUrlInput'>startUrl</label>
                            <input type='text' class='form-control' id='startUrlInput' placeholder='Start URL for this category'
                                name='startUrl'
                                onInput={handleInput}
                        ...
                        <div class='form-check'>
                            <input type='checkbox' class='form-check-input' id='hideLanguageInput'
                                ...
                                value={1}
                                checked={category.hideLanguage ? 'checked' : ''}
                            />
                            <label for='hideLanguageInput'>Skjul språkvalg</label>
                        </div>
                        <div class='form-check'>
                        ...
                        <div class='form-check'>
                            <input type='checkbox' class='form-check-input' id='hideDetailTitleInput'
                                ...
                                onInput={e => {
                                    handleInput(e, {
                                        name: 'hideDetailTitle',
                                        value: category.hideDetailTitle ? 0 : 1,
                                    });
                                }}
                                value={1}
                                checked={category.hideDetailTitle ? 'checked' : ''}
                            />
                            <label for='hideDetailTitleInput'>Skjul artikkel tittel</label>
                        </div>
                        ...
                        <div class='form-check'>
                            <input type='checkbox' class='form-check-input' id='artlistSkipLinkTargetInput'
                                name='artlistSkipLinkTarget'
                                onInput={e => {
                                    handleInput(e, {
                                        name: 'artlistSkipLinkTarget',
                                        value: category.artlistSkipLinkTarget ? 0 : 1,
                                    });
                                }}
                                value={1}
                                checked={category.artlistSkipLinkTarget === 1 ? 'checked' : ''}
                            />
                            <label for='artlistSkipLinkTargetInput'>Ikke bruk link target='_blank'</label>
                        </div>
                        ...
                        <div class='form-group'>
                            <label for='pageFontInput'><i class='fas fa-paint-roller text-muted' /> Page font</label>
                            <textarea type='text' class='form-control' id='pageFontInput' rows='5'
                                name='pageFont'
                                onInput={handleInput}
                                value={category.pageFont}
                            />
                        </div>
                        <div class='form-group'>
                            <label for='pageFontCssInput'><i class='fas fa-paint-roller text-muted' /> Page font activation</label>
                            <textarea type='text' class='form-control' id='pageFontCssInput' rows='5'
                                name='pageFontCss'
                                onInput={handleInput}
                        ...
                        <div class='form-group'>
                            <label for='detailContainerCss'><i class='fas fa-paint-roller text-muted' /> detailContainerCss</label>
                            <textarea type='text' class='form-control' id='detailContainerCss' rows='5'
                                name='detailContainerCss'
                                onInput={handleInput}
                                value={category.detailContainerCss}
                            />
                        </div>
                        ...
                        <div class='form-group'>
                            ...
                            <input type='text' class='form-control' id='artlistImageSizeInput' rows='5'
                        ...
                        <div class='form-group'>
                            <label for='artlistImageCssInput'><i class='fas fa-paint-roller text-muted' /> Artlist Image CSS</label>
                            <textarea type='text' class='form-control' id='artlistImageCssInput' rows='5'
                                name='artlistImageCss'
                                onInput={handleInput}
                                value={category.artlistImageCss}
                            />
                        </div>

                        <div class='form-group'>
                            <label for='artlistColClassInput'><i class='fas fa-paint-roller text-muted' /> Artlist col classes</label>
                            <input type='text' class='form-control' id='artlistColClassInput'
                                name='artlistColClass'
                                onInput={handleInput}
                                value={category.artlistColClass}
                            />
                        </div>
                        <div class='form-group'>
                        ...
                        <div class='form-group'>
                            ...
                            <input type='text' class='form-control' id='artlistContainerClassInput'
                                ...
                                onInput={handleInput}
                                value={category.artlistContainerClass}
                            />
                        </div>
                        <div class='form-group'>
