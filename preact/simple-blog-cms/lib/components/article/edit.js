...
const widgetFields = {
    ...
    'logo-grid': ['category', 'class', 'style', 'wrapper-class', 'wrapper-inner-class', 'class-photo', 'skip-background-images', 'class-photo-img', 'img-wrapper-class', 'img-wrapper-style', 'img-style', 'start', 'end', 'nav-back', 'nav-forward', 'nav-class', 'nav-style', 'autoscroll'],
    ...
    render() {
        ...
        return (
            <small class='text-white'>
                Words: {util.wordCount(value)},
                Read time: {util.readTime(value, 'en')}
            </small>
        );
    }
}
...
export default class Edit extends Component {
    ...
    render() {
        ...
        return (<div class='row bg-secondary'>
            ...
            {language === 'en' && <div class='col-12 d-flex flex-column'>
                ...
                <div class='form-group flex-grow-1'>
                    <button type='button' class='btn btn-sm float-right btn-warning' onClick={translateToEnglish} data-fromfield='body' data-tofield='bodyEn'>Translate to english with Google</button>
                </div>
            </div>}
