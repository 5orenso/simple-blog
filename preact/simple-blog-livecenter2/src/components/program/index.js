...
class Program extends Component {
    ...
    loadAll = async () => {
        ...
        await articleStore.loadArtlist({ isAdmin, isExpert, limit: 100, category: categoryProgram, key: 'program', sort: 'date' });
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class={`h-100 w-25 text-center py-1 ${isLiveNow ? 'bg-info text-white' : ''}`}
                                        >
                                            <small>
                                                {isThisWeek ? <>
                                        ...
                                        <div
                                            class={`flex-grow-1 px-2 py-1 ${isLiveNow ? 'bg-info text-white' : ''}`}
                                            style={`
                                                overflow: hidden;
