...
//            console.log(art);
            ...
            article.tag_values['artlist-block'] += '<div class="artlist-art">' +
                (_.isArray(art.img) ? '<div class="artlist-image" style="background-image: url(\'/pho/' + art.img[0] + '?w=500\');"><a href="' + art.base_href + art.file + '"><img src="/images/pix.gif" style="height:100%; width:100%;"></a></div>' : '') +
