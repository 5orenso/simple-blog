...
//        console.log('load_artlist->content_root: ', content_root);
//        console.log('load_artlist->relative_path: ', relative_path);
...
//            console.log('article: ', opt);

            return when.promise(function (resolve, reject) {
//                console.log('article->artlist: ', opt.artlist);
                load_article({
