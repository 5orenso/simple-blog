...
//            console.log(art);
            ...
            article.tag_values['artlist-block'] += '<div class="artlist-art">' +
                (_.isArray(art.img) ? '<div class="artlist-image" style="background-image: url(\'/photos/' + art.img[0] + '\');"><a href="' + art.base_href + art.file + '"><img src="/images/pix.gif" style="height:100%; height:100%;"></a></div>' : '') +
