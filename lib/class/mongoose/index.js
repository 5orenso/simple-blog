...
const iotSchema = require('./iotSchema');
const iotDeviceSchema = require('./iotDeviceSchema');
...
class MongooseHelper {
    ...
    static async connectGlobal(config) {
        ...
        GLOBAL_MODELS.iot = mongoose.model('iot', SCHEMAS.iot);
        GLOBAL_MODELS.iotDevice = mongoose.model('iotDevice', SCHEMAS.iotDevice);
        GLOBAL_MODELS.sequence = mongoose.model('sequence', SCHEMAS.sequence);
        GLOBAL_MODELS.event = mongoose.model('event', SCHEMAS.event);
        try {
