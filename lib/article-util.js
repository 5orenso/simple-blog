...
//            console.log('getArticleFilename->complete_filename: ', complete_filename);
            if (_.isString(complete_filename)) {
                var filename = complete_filename.replace(/^.*\//, '');
                return filename;
            } else {
                return 'index';
            }
...
//            console.log('getArticlePathRelative: ', complete_path);
//            console.log('getArticlePathRelative->content_path: ', content_path);
...
//                console.log('getArticlePathRelative->content_path->regex: ', re);
...
//                console.log('getArticlePathRelative->relative_path->done: ', relative_path);
            }
//            console.log('getArticlePathRelative->all->done: ', relative_path, complete_path, content_path);
        ...
        getMarkdownFilename: function getMarkdownFilename (article_filename, content_path) {
//            console.log('getMarkdownFilename->article_filename: ', article_filename, content_path);
            if ( !_.isString(article_filename) || article_filename.match(/^$/) ) {
                article_filename = 'index';
            }
            var markdown_filename = path.normalize(content_path + article_filename + '.md');
            console.log('getMarkdownFilename->markdown_filename: ', markdown_filename, content_path);
...
//            console.log('formatArtlist->artlist: ', artlist);
