                    ...
                    if (_.isString(article[mode]) && article[mode].length > 0) {
                        ...
                        if (mode.match(/^(col)$/)) {
                            if (!_.isArray(article[mode])) {
                                article[mode] = [];
                            } else if (line_contains_mode) {
                                colNumber++;                           
                            }
                            if (_.isEmpty(article[mode][colNumber])) {
                                article[mode][colNumber] = data_line;
                            } else {
                                article[mode][colNumber] += "\n" + data_line;
                            }                                                        
